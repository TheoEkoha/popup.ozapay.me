...
export default function Count() {
  ...
  useEffect(() => {
    ...
    const target = new Date("03/31/2024 17:00:00");
        ...
        <div className={showModal ? styles.modalCount : styles.modalHidden}>
          ...
          <nav className={styles.verticalSocial}>
            <ul>
              ...
              <li>
                <a target="_blank" href="https://t.me/Ozapay_officiel">
                  <SiTelegram />
                </a>
              </li>
              <li>
                <a target="_blank" href="https://www.instagram.com/Ozapay/">
                  <SiInstagram />
                </a>
              </li>
              <li>
              ...
              <div className={styles.leftBox}>
                ...
                <p className={styles.bottomText}>
                  ...
                  <a
                    ...
                    href={
                      changeLink
                        ? "/pdf/white_paper_ozapay_en.pdf"
                        : "/pdf/white_paper_ozapay_fr.pdf"
                    }
                  >
                    {t("here")}
                  </a>
